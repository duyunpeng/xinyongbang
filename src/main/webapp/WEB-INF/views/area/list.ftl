...
<div class="row margin-md">
    <a href="/area/create" class="btn btn-md btn-success">新增区域</a>
</div>
<div class="smart-widget widget-dark-blue">
    ...
    <div class="smart-widget-inner">
        ...
        <div class="smart-widget-body no-padding">
            ...
            <div class="bg-grey">
                [#if pagination!]
            [@mc.showPagination '/area/pagination?name=${command.name!}&status=${command.status!}&level=${command.level!}' /]
        [/#if]
            </div>
        </div>
