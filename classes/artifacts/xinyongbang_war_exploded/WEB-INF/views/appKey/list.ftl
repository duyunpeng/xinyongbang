...
<div class="row margin-md">
    <a href="/app_key/create" class="btn btn-md btn-success">新增AppKey</a>
</div>
<div class="smart-widget widget-dark-blue">
    ...
    <div class="smart-widget-inner">
        ...
        <div class="smart-widget-body no-padding">
                        ...
                        <tbody>
                            [#if pagination.data??]
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="[@spring.url '/app_key/info/${appKey.id!}'/]" data-toggle="tooltip"
                                           data-placement="top" title="点击查看详情">
                                            <span class="label label-info">查看</span>
                                        </a>
                                        <a href="[@spring.url '/app_key/edit/${appKey.id!}'/]" data-toggle="tooltip"
            ...
            <div class="bg-grey">
                [#if pagination!]
            [@mc.showPagination '/app_key/pagination?name=${command.name!}&status=${command.status!}' /]
        [/#if]
            </div>
        </div>
