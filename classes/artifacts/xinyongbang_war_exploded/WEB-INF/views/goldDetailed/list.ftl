[@override name="title"]金币明细[/@override]
...
<div class="smart-widget widget-dark-blue">
    ...
    <div class="smart-widget-inner">
        ...
        <div class="smart-widget-body no-padding">
            <div class="padding-md">
                <section class="overflow-auto nice-scrollbar">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            [#if pagination.data??]
                                [#list pagination.data as goldDetailed ]
                                <tr>
                                    <td>${goldDetailed.user.userName!}</td>
                                    <td>${goldDetailed.goldNumber!}</td>
                                    <td>${(goldDetailed.flowType.getName())!}</td>
                                    <td>[@mc.dateShow goldDetailed.createDate/]</td>
                                    <td>${goldDetailed.description!}</td>
                                    <td>
                                        <a href="[@spring.url '/gold_detailed/info/${goldDetailed.id!}'/]"
            ...
            <div class="bg-grey">
                [#if pagination!]
            [@mc.showPagination '/gold_detailed/pagination?userName=${command.userName!}&flowType=${command.flowType!}' /]
        [/#if]
            </div>
        </div>
