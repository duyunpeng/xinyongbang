[@override name="title"]幻灯片管理 - 幻灯片修改[/@override]
...
<div class="row">
    <div class="col-lg-8">
        <form class="form-horizontal" action="/slide/edit" method="post" data-parsley-validate>
            <input type="hidden" name="id" value="${slide.id!command.id}"/>
            <input type="hidden" name="version" value="${slide.version!command.version}"/>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input class="form-control" id="sort" name="sort"
                           value="${slide.sort!command.sort}" placeholder="输入排序"
                ...
                <div class="col-md-9">
                    ...
                    <section class="overflow-auto nice-scrollbar">
                        <ul class="img-box">
                            [#if slide.picture??]
                                <li>
                                    <img src="${slide.picture.picPath!}">
                                    <input type="hidden"
                                           value="${slide.picture.picPath!}"
                                           name="picture">
                                    <div><a href="#" class="btn btn-danger del-img">删除</a></div>
                                </li>
                            [/#if]
                        </ul>
                    </section>
