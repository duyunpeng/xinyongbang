        ...
        <div class="row">
            <div class="col-sm-4 col-md-12" data-toggle="tooltip" data-placement="" title="点击更换头像">
                <div class="user-profile-pic">
                    <img id="head-img"
                         src="${Session["sessionUser"].headPic.picPath?default('/resources/images/profile/profile1.jpg')}"
                         alt="">
            ...
            <div class="col-sm-6 col-md-12">
                <div class="user-name m-top-sm">${Session["sessionUser"].userName!}<i
                        class="fa fa-circle text-success m-left-xs font-14"></i>
                </div>
