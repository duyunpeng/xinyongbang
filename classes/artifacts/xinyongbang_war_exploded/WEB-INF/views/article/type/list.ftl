[@override name="title"]文章类型管理[/@override]
...
<div class="row margin-md">
    <a href="/article_type/create" class="btn btn-md btn-success">新增文章类型</a>
</div>
<div class="smart-widget widget-dark-blue">
    <div class="smart-widget-header">
        ...
        <form class="form-inline no-margin" role="form">
            <div class="form-group">
                <label for="name" class="control-label">文章类型名称</label>
                <input type="text" class="form-control" id="title" name="name" value="${command.name!}"
                       placeholder="文章类型名称"/>
            </div>
            <div class="form-group">
                <label for="status" class="control-label">文章类型状态</label>
    ...
    <div class="smart-widget-inner">
        ...
        <div class="smart-widget-body no-padding">
            <div class="padding-md">
                <section class="overflow-auto nice-scrollbar">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            [#if pagination.data??]
                                [#list pagination.data as articleType ]
                                <tr>
                                    <td>${articleType.name!}</td>
                                    <td>[@mc.dateShow articleType.createDate/]</td>
                                    <td>${(articleType.status.getName())!}</td>
                                    <td>
                                        <a href="[@spring.url '/article_type/info/${articleType.id!}'/]"
                                           data-toggle="tooltip" data-placement="top" title="点击查看详情">
                                            <span class="label label-info">查看</span>
                                        </a>
                                        <a href="[@spring.url '/article_type/edit/${articleType.id!}'/]"
                                           data-toggle="tooltip" data-placement="top" title="点击修改信息">
                                            <span class="label label-success">修改</span>
                                        </a>
                                        [#if articleType.status == "ENABLE"]
                                            <a href="[@spring.url '/article_type/update_status?id=${articleType.id!}&version=${articleType.version!}'/]"
            ...
            <div class="bg-grey">
                [#if pagination!]
            [@mc.showPagination '/article_type/pagination?name=${command.name!}&status=${command.status!}' /]
        [/#if]
            </div>
        </div>
